  ...
  return (
    <tr>
          ...
          <div class="flex-auto">
            <div class="flex items-start gap-x-3">
              ...
              <div
                ...
                classList={{
                  "text-green-700 bg-green-50 ring-green-600/20": props.data.type === "online_presale",
      ...
      <td class="py-5 text-right">
        ...
        <div class="mt-1 text-xs leading-5 text-gray-500">Identifiant <span
          class="text-gray-900">#{props.data.id}</span></div>
      </td>
    </tr>
  );
};